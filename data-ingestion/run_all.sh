...
invoke_validation() {
    ...
    local bucket="bus-mvp-datalake-1"
    if [ -f "$SCRIPT_DIR/.env" ]; then
...
show_summary() {
    ...
    echo "  📁 s3://bus-mvp-datalake-1/raw/passengers_csv/"
    echo "  📁 s3://bus-mvp-datalake-1/raw/trips_csv/"
    echo "  📁 s3://bus-mvp-datalake-1/raw/tickets_csv/"
