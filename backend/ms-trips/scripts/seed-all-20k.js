...
const CONFIG = {
  ...
  mysql: {
    host: process.env.SQL2_HOST || process.env.MYSQL_HOST || 'mysql-trips',
  ...
  postgres: {
    host: process.env.POSTGRES_HOST || 'postgres-passengers',
  ...
  mongodb: {
    url: process.env.SPRING_DATA_MONGODB_URI || 'mongodb://tickets_user:tickets_password@mongo-tickets:27017/tickets_db?authSource=tickets_db',
